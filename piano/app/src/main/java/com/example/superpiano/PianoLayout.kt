...
class PianoLayout : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        naturalTones.forEach{ originalNoteValue ->
            ...
            fragmentTransaction.add(view.whitePianoKeyLayout.id, naturalTonePianoKey, "note_$originalNoteValue")
        }


        semiTones.forEach { originalNoteValue ->
            val semiTonePianoKey = BlackPianoKeyFregment.newInstance(originalNoteValue)
            var startTimeOfNote:Long =0
            ...
            fragmentTransaction.add(view.blackPianoKeyLayout.id, semiTonePianoKey, "note_$originalNoteValue")
        }
